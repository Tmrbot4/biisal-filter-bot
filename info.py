...
URL = "https://vishall-99234ccba7bd.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://vishall-99234ccba7bd.herokuapp.com/".format(FQDN, PORT)
...
BOT_TOKEN = environ.get('BOT_TOKEN', "7013966415:AAF42iyER8MPyF--d5Emb3Pc69tUk-do-Cw") #if you are going to bot token here make sure your repo is private..
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://tmr624063:tmr624063@cluster0.poldyrv.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Visha")
